            ...
            get
            {
                switch (t)
                {
                    ...
                    case MessageType.FilesOrFoldersUpdated:
                        return Get("/tray/FilesOrFoldersUpdated", "{0} {1} à été mis à jour");
                    case MessageType.FilesOrFoldersCreated:
                        return Get("/tray/FilesOrFoldersCreated", "{0} {1} à été crée");
                    ...
                    case MessageType.Uploading:
                        return Get("/tray/uploading", "Envoie {0}");
            ...
            get
            {
                switch(c)
                {
                    ...
                    case UiControl.CopyUrl:
                        return Get("/main_form/copy", "Copier le lien dans le presse papeir");
