...
namespace FTPbox.Forms
{
    public partial class Setup : Form
    {
        ...
        private void bFinish_Click(object sender, EventArgs e)
        {
            ...
            var destinationDuRaccourci = string.Format(@"{0}\iwit sync.lnk", Environment.GetFolderPath(Environment.SpecialFolder.DesktopDirectory));
        ...
        private void SetDefaultLocalPathINSTANT()
        {
            ...
            iconDefautltPath2.CreateFolderIcon(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86) + "\\Iwit Systems\\IwitSync\\regular.ico", "iwitSync");
