...
namespace FTPbox.Forms
{
    public partial class fMain : Form
    {
        ...
        /// <summary>
        /// Permet de faire apparaitre le controle de maintenance apres combinaison de touches (CTRL + SHIFT + M)
        /// </summary>
            ...
            Program.Account.WebInterface.UpdateFound += (o, n) =>
                {
                    ...
                    if (MessageBox.Show(msg, "iwit sync - WebUI Update", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                    {
        ...
        public void UpdateDetails()
        {
            ...
            if (nSyncFrequency.Value == 0) nSyncFrequency.Value = 30;
        ...
        private void CopyArgLinks(string[] args)
        {
            ...
            foreach (string s in args)
            {
                ...
                {
                    MessageBox.Show("You cannot use this for files that are not inside the iwitSync folder.", "iwit sync - Invalid file", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    continue;
                }
        ...
        private void cProfiles_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            var msg = string.Format("Switch to {0} ?", FTPboxLib.Settings.ProfileTitles[cProfiles.SelectedIndex]);
        ...
        private void nSyncFrequency_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                Program.Account.Account.SyncFrequency = (Int32)30;
            }
            FTPboxLib.Settings.SaveProfile();
        }
        ...
        private void bShortCut_Click(object sender, EventArgs e)
        {
            ...
            CreateShortcut(pathDuRaccourci, destinationDuRaccourci);
        }
