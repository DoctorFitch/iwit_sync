...
namespace FTPbox
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (!DLLsExist)
            {
                MessageBox.Show("The required DLL files to run this program are missing. Please make sure all the needed files are in the installation folder and then run the application. If you cannot find these files, just reinstall iwit sync.", "iwit sync - Missing Resources", MessageBoxButtons.OK, MessageBoxIcon.Error);
