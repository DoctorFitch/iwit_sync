...
namespace FTPboxLib
{
    public static partial class Common
    {
        ...
        public static string AppdataFolder
        {
            get
            {
                return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), @"iwitSync");
            }
        }
        ...
        {
            get { return LanguageList.ToList().ConvertAll(x => string.Format("{0}", x.Value)).ToArray(); }
        }
