...
#else
                        FileIO.FileSystem.DeleteFile(item.LocalPath, FileIO.UIOption.OnlyErrorDialogs, FileIO.RecycleOption.DeletePermanently);
#endif
                    else if (item.Item.Type == ClientItemType.Folder)
#if __MonoCs__
                        Directory.Delete(item.LocalPath, true);
#else
                        FileIO.FileSystem.DeleteDirectory(item.LocalPath, FileIO.UIOption.OnlyErrorDialogs, FileIO.RecycleOption.DeletePermanently);
#endif
