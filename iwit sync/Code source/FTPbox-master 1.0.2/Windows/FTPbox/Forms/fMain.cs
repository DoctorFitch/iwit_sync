...
namespace FTPbox.Forms
{
    public partial class fMain : Form
    {
        ...
        public fMain()
        {
            ...
            labelMaintenanceInfo.Visible = true;
        }

        /// <summary>
        /// Permet de demarrer un processus windows
        /// </summary>
        ...
        /// <summary>
        /// Permet d'arreter un processus windows
        /// </summary>
        /// <param name="serviceName"></param>
        /// <param name="timeoutMilliseconds"></param>
        ...
        /// <summary>
        /// Permet de faire apparaitre le controle de maintenance apres combinaison de touches (CTRL + SHIFT + F)
        /// </summary>
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            if (keyData == (Keys.Control | Keys.Shift | Keys.F))
            {
                ...
                labelMaintenanceInfo.Visible = false;
                return true;
            }
        ...
        private void SyncArgItems(string[] args)
        {
            foreach (string s in args)
            {
                ...
                if (!s.StartsWith(Program.Account.Paths.Local))
                {
                    MessageBox.Show("Vous ne pouvez pas utiliser un fichier qui ne se trouvent pas dans le dossier de synchronisation iwit sync.", "iwit sync - Fichier invalide", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    continue;
                }
        ...
        private void bShortCut_Click(object sender, EventArgs e)
        {
            ...
            var pathDuRaccourci = string.Format(@"{0}\iwit sync\", Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments));
        ...
        {
            string msg = string.Format("Etes vous sur de vouloir configurer à nouveau votre compte : {0} ?" + Environment.NewLine + Environment.NewLine + "Attention : Les paramètres actuels de connexion seront supprimés." + Environment.NewLine + "Votre dossier de fichier ne sera pas affecté.",
                   FTPboxLib.Settings.ProfileTitles[FTPboxLib.Settings.General.DefaultProfile]);
        ...
        {
            MessageBox.Show(Environment.GetFolderPath(Environment.SpecialFolder.ProgramFilesX86) + "\\Iwit Systems\\iwit sync\\regular.ico");
        }
        ...
        private void aideToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            p.StartInfo.FileName = "http://www.iwit-app.fr/iwitsync";
            p.Start();
        }

        private void ouvrirLeDossierToolStripMenuItem_Click(object sender, EventArgs e)
        {
            System.Diagnostics.Process.Start("explorer.exe", string.Format(@"{0}\iwit sync\", Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)));
        }
    }
}
