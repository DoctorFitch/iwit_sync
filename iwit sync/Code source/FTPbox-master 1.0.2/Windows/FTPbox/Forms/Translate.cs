...
namespace FTPbox.Forms
{
    public partial class Translate : Form
    {
        ...
        private void bContinue_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (tLanguage.Text != "" && tShortCode.Text != "")
                {
                    ...
                    MessageBox.Show("Please fill in both the language and the short code before you continue.", "iwit sync - Fields Empty", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }            
        ...
        {
            if (!allFilled)
                MessageBox.Show("Please fill in all the cells before you continue.", "iwit sync - Warning", MessageBoxButtons.OK, MessageBoxIcon.Information);
            else
            {
                string text = "";
                string parent = "";
